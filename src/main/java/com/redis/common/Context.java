...
//	public static RedisChannel getEumChannel(String value) {
//		if (RedisChannel.PERMISSION.getValue().equals(value)) {
//			return RedisChannel.PERMISSION;
//		} else if (RedisChannel.DICTIONARY.getValue().equals(value)) {
//			return RedisChannel.DICTIONARY;
//		} else if (RedisChannel.DISTRICT.getValue().equals(value)) {
//			return RedisChannel.DISTRICT;
//		} else if (RedisChannel.INDUSTRY.getValue().equals(value)) {
//			return RedisChannel.INDUSTRY;
//		} else if (RedisChannel.DEVZONE.getValue().equals(value)) {
//			return RedisChannel.DEVZONE;
//		} else if (RedisChannel.SENSITIVE.getValue().equals(value)) {
//			return RedisChannel.SENSITIVE;
//		}
//		return null;
//	}
